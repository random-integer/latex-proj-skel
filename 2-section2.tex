...
時間\footnote{脚注を付けてみた。ほげほげ。コミュニケーション。The quick brown fox 云々。}を無駄にしちゃった。
...
\begin{equation}
    ...
    \label{eq:bb4ac2a}
\end{equation}
だよ。式 \ref{eq:bb4ac2a} のように、ほげほげ。

\url{https://j-sda.or.jp/statistically-information/pdf/2025jsda_databook.pdf}
